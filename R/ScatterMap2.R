#' @title ScatterMap2: Points in a red - green scale on top of maps. 
#' @description The function \code{ScatterMap2} returns a map (land/ ocean) with 
#' points on top. Colors according to strength in input. 
#' @details ...
#' @param shape_file [\code{path}] to shape file
